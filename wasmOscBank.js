...
// end include: preamble.js
  ...
  var _emscripten_start_wasm_audio_worklet_thread_async = (contextHandle, stackLowestAddress, stackSize, callback, userData) => {
      ...
      audioWorklet.addModule('wasmOscBank.aw.js').then(() => {
...
var _startAudioWorkletThread = Module['_startAudioWorkletThread'] = createExportWrapper('startAudioWorkletThread', 1);
var _createAudioWorkletProcessor = Module['_createAudioWorkletProcessor'] = createExportWrapper('createAudioWorkletProcessor', 1);
var _connectAudioWorkletProcessor = Module['_connectAudioWorkletProcessor'] = createExportWrapper('connectAudioWorkletProcessor', 1);
